...
/opt/forgerock/opendj_usr/opendj/setup directory-server --rootUserDn cn=DirectoryManager --rootUserPassword Inside@123   --monitorUserDn uid=Monitor --monitorUserPassword Inside@123 --hostname nausawsodj601.corp.valvoline.com    --doNotStart    --adminConnectorPort $adminConnectorPort    --ldapPort $ldapPort   --enableStartTls  --ldapsPort $ldapsPort  --httpsPort $httpsPort  --addBaseEntry  --baseDn dc=valvoline,dc=com --acceptLicense
